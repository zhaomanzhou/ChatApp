...
public class UDPSearcher {
    ...
    public static ServerInfo searchServer(int timeout) {
        System.out.println("foreground.net.UDPSearcher Started.");
        ...
        // 完成
        System.out.println("foreground.net.UDPSearcher Finished.");
        if (listener == null) {
            return null;
        }
    ...
    private static Listener listen(CountDownLatch receiveLatch) throws InterruptedException {
        System.out.println("foreground.net.UDPSearcher start listen.");
    ...
    private static void sendBroadcast() throws IOException {
        System.out.println("foreground.net.UDPSearcher sendBroadcast started.");
        ...
        // 完成
        System.out.println("foreground.net.UDPSearcher sendBroadcast finished.");
    }
        ...
        public void run() {
            ...
            try {
                ...
                while (!done) {
                    ...
                    System.out.println("foreground.net.UDPSearcher receive form ip:" + ip
                    ...
                    if (cmd != 2 || serverPort <= 0) {
                        System.out.println("foreground.net.UDPSearcher receive cmd:" + cmd + "\tserverPort:" + serverPort);
                        continue;
                    }
            ...
            System.out.println("foreground.net.UDPSearcher listener finished.");
        }
